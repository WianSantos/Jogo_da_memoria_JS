//metodos estáticos nao podem acessar o metodo 'this'
//por isso nao vamos colocar o util no constructor
const util = Util

const ID_BTN_JOGAR = 'jogar'
const ID_MOSTRAR_TUDO = 'mostrar'
...
class Tela {
  ...
  static exibirHerois(nomeDoheroi, img) {
    ...
    // para cada elemento encontrado na tekla, vamos alterar a imagem
  ...
  static iniciarContador() {
    ...
    // vamos criar uma funcao em uma linha paraatualizar o texto a cada segundo
    ...
    atualizarTexto()
    // a cada segundo vai chamar a funcao de atualizar o texto, essa fuincao vai substituir o $$contador pelo contarAte
  ...
  configurarBotaoMostrarTudo(funcaoOnClick) {
    const btnMostrarTudo = document.getElementById(mostraTudo)
